...
#if !defined(KW47Z420B2_COMMON_H_)
#define KW47Z420B2_COMMON_H_                     /**< Symbol preventing repeated inclusion */
...
#include "system_KW47Z420B2.h"         /* Device specific configuration file */
