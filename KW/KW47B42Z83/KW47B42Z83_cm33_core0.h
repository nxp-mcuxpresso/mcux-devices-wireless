...
#if !defined(KW47B42Z83_cm33_core0_H_)  /* Check if memory map has not been already included */
#define KW47B42Z83_cm33_core0_H_
...
#endif  /* #if !defined(KW47B42Z83_cm33_core0_H_) */
