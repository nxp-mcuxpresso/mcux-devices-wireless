...
#if !defined(KW47B42Z83_cm33_core1_H_)  /* Check if memory map has not been already included */
#define KW47B42Z83_cm33_core1_H_
...
#endif  /* #if !defined(KW47B42Z83_cm33_core1_H_) */
