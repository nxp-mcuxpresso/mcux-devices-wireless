...
#if !defined(RW610_COMMON_H_)
#define RW610_COMMON_H_                          /**< Symbol preventing repeated inclusion */
...
#include "system_RW610.h"              /* Device specific configuration file */
