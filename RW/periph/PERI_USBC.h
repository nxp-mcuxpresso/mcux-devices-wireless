...
typedef struct {
  ...
  __IO uint32_t OTG_CONTROL;                       /**< OTG Control, offset: 0x234 */
  __IO uint32_t CHGDTC_CONTRL;                     /**< Charger Detector Control, offset: 0x238 */
} USBC_Type;
...
/*! @name OTG_CONTROL - OTG Control */
/*! @{ */

#define USBC_OTG_CONTROL_PU_OTG_MASK             (0x10U)
#define USBC_OTG_CONTROL_PU_OTG_SHIFT            (4U)
/*! PU_OTG - OTG power control */
#define USBC_OTG_CONTROL_PU_OTG(x)               (((uint32_t)(((uint32_t)(x)) << USBC_OTG_CONTROL_PU_OTG_SHIFT)) & USBC_OTG_CONTROL_PU_OTG_MASK)

#define USBC_OTG_CONTROL_OTG_CONTROL_BY_PIN_MASK (0x20U)
#define USBC_OTG_CONTROL_OTG_CONTROL_BY_PIN_SHIFT (5U)
/*! OTG_CONTROL_BY_PIN - OTG Power Controll Select */
#define USBC_OTG_CONTROL_OTG_CONTROL_BY_PIN(x)   (((uint32_t)(((uint32_t)(x)) << USBC_OTG_CONTROL_OTG_CONTROL_BY_PIN_SHIFT)) & USBC_OTG_CONTROL_OTG_CONTROL_BY_PIN_MASK)
/*! @} */

/*! @name CHGDTC_CONTRL - Charger Detector Control */
/*! @{ */

#define USBC_CHGDTC_CONTRL_CDP_EN_MASK           (0x4U)
#define USBC_CHGDTC_CONTRL_CDP_EN_SHIFT          (2U)
/*! CDP_EN - Charging Downstream Port Mode Enable */
#define USBC_CHGDTC_CONTRL_CDP_EN(x)             (((uint32_t)(((uint32_t)(x)) << USBC_CHGDTC_CONTRL_CDP_EN_SHIFT)) & USBC_CHGDTC_CONTRL_CDP_EN_MASK)

#define USBC_CHGDTC_CONTRL_DCP_EN_MASK           (0x8U)
#define USBC_CHGDTC_CONTRL_DCP_EN_SHIFT          (3U)
/*! DCP_EN - Dedicated Charging Port Mode Enable */
#define USBC_CHGDTC_CONTRL_DCP_EN(x)             (((uint32_t)(((uint32_t)(x)) << USBC_CHGDTC_CONTRL_DCP_EN_SHIFT)) & USBC_CHGDTC_CONTRL_DCP_EN_MASK)

#define USBC_CHGDTC_CONTRL_PD_EN_MASK            (0x10U)
#define USBC_CHGDTC_CONTRL_PD_EN_SHIFT           (4U)
/*! PD_EN - Portable Device Mode Enable */
#define USBC_CHGDTC_CONTRL_PD_EN(x)              (((uint32_t)(((uint32_t)(x)) << USBC_CHGDTC_CONTRL_PD_EN_SHIFT)) & USBC_CHGDTC_CONTRL_PD_EN_MASK)

#define USBC_CHGDTC_CONTRL_PU_CHRG_DTC_MASK      (0x20U)
#define USBC_CHGDTC_CONTRL_PU_CHRG_DTC_SHIFT     (5U)
/*! PU_CHRG_DTC - Powe Up Charge Detector */
#define USBC_CHGDTC_CONTRL_PU_CHRG_DTC(x)        (((uint32_t)(((uint32_t)(x)) << USBC_CHGDTC_CONTRL_PU_CHRG_DTC_SHIFT)) & USBC_CHGDTC_CONTRL_PU_CHRG_DTC_MASK)

#define USBC_CHGDTC_CONTRL_DP_DM_SWAP_CTRL_MASK  (0x40U)
#define USBC_CHGDTC_CONTRL_DP_DM_SWAP_CTRL_SHIFT (6U)
/*! DP_DM_SWAP_CTRL - DP/DM Swap Control */
#define USBC_CHGDTC_CONTRL_DP_DM_SWAP_CTRL(x)    (((uint32_t)(((uint32_t)(x)) << USBC_CHGDTC_CONTRL_DP_DM_SWAP_CTRL_SHIFT)) & USBC_CHGDTC_CONTRL_DP_DM_SWAP_CTRL_MASK)

#define USBC_CHGDTC_CONTRL_CDP_DM_AUTO_SWITCH_MASK (0x80U)
#define USBC_CHGDTC_CONTRL_CDP_DM_AUTO_SWITCH_SHIFT (7U)
/*! CDP_DM_AUTO_SWITCH - CDP Mode DM Port Automatic Switch */
#define USBC_CHGDTC_CONTRL_CDP_DM_AUTO_SWITCH(x) (((uint32_t)(((uint32_t)(x)) << USBC_CHGDTC_CONTRL_CDP_DM_AUTO_SWITCH_SHIFT)) & USBC_CHGDTC_CONTRL_CDP_DM_AUTO_SWITCH_MASK)

#define USBC_CHGDTC_CONTRL_VDAT_CHARGE_MASK      (0x300U)
#define USBC_CHGDTC_CONTRL_VDAT_CHARGE_SHIFT     (8U)
/*! VDAT_CHARGE - VDAT Reference Voltage Control */
#define USBC_CHGDTC_CONTRL_VDAT_CHARGE(x)        (((uint32_t)(((uint32_t)(x)) << USBC_CHGDTC_CONTRL_VDAT_CHARGE_SHIFT)) & USBC_CHGDTC_CONTRL_VDAT_CHARGE_MASK)

#define USBC_CHGDTC_CONTRL_VSRC_CHARGE_MASK      (0xC00U)
#define USBC_CHGDTC_CONTRL_VSRC_CHARGE_SHIFT     (10U)
/*! VSRC_CHARGE - VSRC Reference Voltage Control */
#define USBC_CHGDTC_CONTRL_VSRC_CHARGE(x)        (((uint32_t)(((uint32_t)(x)) << USBC_CHGDTC_CONTRL_VSRC_CHARGE_SHIFT)) & USBC_CHGDTC_CONTRL_VSRC_CHARGE_MASK)

#define USBC_CHGDTC_CONTRL_ENABLE_SWITCH_DP_MASK (0x1000U)
#define USBC_CHGDTC_CONTRL_ENABLE_SWITCH_DP_SHIFT (12U)
/*! ENABLE_SWITCH_DP - Enable DP Port Switch */
#define USBC_CHGDTC_CONTRL_ENABLE_SWITCH_DP(x)   (((uint32_t)(((uint32_t)(x)) << USBC_CHGDTC_CONTRL_ENABLE_SWITCH_DP_SHIFT)) & USBC_CHGDTC_CONTRL_ENABLE_SWITCH_DP_MASK)

#define USBC_CHGDTC_CONTRL_ENABLE_SWITCH_DM_MASK (0x2000U)
#define USBC_CHGDTC_CONTRL_ENABLE_SWITCH_DM_SHIFT (13U)
/*! ENABLE_SWITCH_DM - Enable DM Port Switch */
#define USBC_CHGDTC_CONTRL_ENABLE_SWITCH_DM(x)   (((uint32_t)(((uint32_t)(x)) << USBC_CHGDTC_CONTRL_ENABLE_SWITCH_DM_SHIFT)) & USBC_CHGDTC_CONTRL_ENABLE_SWITCH_DM_MASK)
/*! @} */
