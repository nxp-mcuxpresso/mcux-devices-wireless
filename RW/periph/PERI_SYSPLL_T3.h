...
#define SYSPLL_T3_CLKTREE_CTRL_SIX_REG_REG_CLKTREE_CTRL_SIX_MASK (0xFU)
#define SYSPLL_T3_CLKTREE_CTRL_SIX_REG_REG_CLKTREE_CTRL_SIX_SHIFT (0U)
/*! REG_CLKTREE_CTRL_SIX - Tune MCI_60MHz.0x5=59.53MHz,0xA:48.30MHz */
#define SYSPLL_T3_CLKTREE_CTRL_SIX_REG_REG_CLKTREE_CTRL_SIX(x) (((uint8_t)(((uint8_t)(x)) << SYSPLL_T3_CLKTREE_CTRL_SIX_REG_REG_CLKTREE_CTRL_SIX_SHIFT)) & SYSPLL_T3_CLKTREE_CTRL_SIX_REG_REG_CLKTREE_CTRL_SIX_MASK)
