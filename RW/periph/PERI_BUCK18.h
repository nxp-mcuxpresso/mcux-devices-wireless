...
#define BUCK18_BUCK_CTRL_THREE_REG_RSVD0_MASK    (0x3U)
#define BUCK18_BUCK_CTRL_THREE_REG_RSVD0_SHIFT   (0U)
/*! RSVD0 - Reserved.Do not change */
#define BUCK18_BUCK_CTRL_THREE_REG_RSVD0(x)      (((uint8_t)(((uint8_t)(x)) << BUCK18_BUCK_CTRL_THREE_REG_RSVD0_SHIFT)) & BUCK18_BUCK_CTRL_THREE_REG_RSVD0_MASK)

#define BUCK18_BUCK_CTRL_THREE_REG_REG_BUCK_CTRL_THREE_MASK (0xCU)
#define BUCK18_BUCK_CTRL_THREE_REG_REG_BUCK_CTRL_THREE_SHIFT (2U)
/*! REG_BUCK_CTRL_THREE - Tune Non-Overlapping time of power transistor of BUCK18.Do not change */
...
#define BUCK18_BUCK_CTRL_THREE_REG_RSVD1_MASK    (0xF0U)
#define BUCK18_BUCK_CTRL_THREE_REG_RSVD1_SHIFT   (4U)
/*! RSVD1 - Reserved.Do not change */
#define BUCK18_BUCK_CTRL_THREE_REG_RSVD1(x)      (((uint8_t)(((uint8_t)(x)) << BUCK18_BUCK_CTRL_THREE_REG_RSVD1_SHIFT)) & BUCK18_BUCK_CTRL_THREE_REG_RSVD1_MASK)
/*! @} */
...
#define BUCK18_BUCK_CTRL_ELEVEN_REG_RSVD0_MASK   (0x7U)
#define BUCK18_BUCK_CTRL_ELEVEN_REG_RSVD0_SHIFT  (0U)
/*! RSVD0 - Reserved.Do not change */
#define BUCK18_BUCK_CTRL_ELEVEN_REG_RSVD0(x)     (((uint8_t)(((uint8_t)(x)) << BUCK18_BUCK_CTRL_ELEVEN_REG_RSVD0_SHIFT)) & BUCK18_BUCK_CTRL_ELEVEN_REG_RSVD0_MASK)

#define BUCK18_BUCK_CTRL_ELEVEN_REG_REG_BUCK_CTRL_ELEVEN_MASK (0x8U)
#define BUCK18_BUCK_CTRL_ELEVEN_REG_REG_BUCK_CTRL_ELEVEN_SHIFT (3U)
/*! REG_BUCK_CTRL_ELEVEN - Use BUCK18 output for internal V18 rails. Do not change */
...
#define BUCK18_BUCK_CTRL_ELEVEN_REG_RSVD1_MASK   (0xF0U)
#define BUCK18_BUCK_CTRL_ELEVEN_REG_RSVD1_SHIFT  (4U)
/*! RSVD1 - Reserved.Do not change */
#define BUCK18_BUCK_CTRL_ELEVEN_REG_RSVD1(x)     (((uint8_t)(((uint8_t)(x)) << BUCK18_BUCK_CTRL_ELEVEN_REG_RSVD1_SHIFT)) & BUCK18_BUCK_CTRL_ELEVEN_REG_RSVD1_MASK)
/*! @} */
