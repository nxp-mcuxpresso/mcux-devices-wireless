...
#define BUCK11_BUCK_CTRL_THREE_REG_RSVD0_MASK    (0x3U)
#define BUCK11_BUCK_CTRL_THREE_REG_RSVD0_SHIFT   (0U)
/*! RSVD0 - Reserved.Do not change */
#define BUCK11_BUCK_CTRL_THREE_REG_RSVD0(x)      (((uint8_t)(((uint8_t)(x)) << BUCK11_BUCK_CTRL_THREE_REG_RSVD0_SHIFT)) & BUCK11_BUCK_CTRL_THREE_REG_RSVD0_MASK)

#define BUCK11_BUCK_CTRL_THREE_REG_REG_BUCK_CTRL_THREE_MASK (0xCU)
#define BUCK11_BUCK_CTRL_THREE_REG_REG_BUCK_CTRL_THREE_SHIFT (2U)
/*! REG_BUCK_CTRL_THREE - Tune Non-Overlapping time of power transistor of BUCK11.Do not change */
...
#define BUCK11_BUCK_CTRL_THREE_REG_RSVD1_MASK    (0xF0U)
#define BUCK11_BUCK_CTRL_THREE_REG_RSVD1_SHIFT   (4U)
/*! RSVD1 - Reserved.Do not change */
#define BUCK11_BUCK_CTRL_THREE_REG_RSVD1(x)      (((uint8_t)(((uint8_t)(x)) << BUCK11_BUCK_CTRL_THREE_REG_RSVD1_SHIFT)) & BUCK11_BUCK_CTRL_THREE_REG_RSVD1_MASK)
/*! @} */
...
/*! EXT_BG_CAL_CODE - External calibration code for BG.Do not change */
...
/*! SEL_BG_CAL_CODE - Select internal or external calibration code for BG.Do not change */
...
/*! SHORT_C11_ENB - Short switch enable signal for internal C11.Do not change */
...
/*! LPBG_TRIM - Bandgap temperature curve trimming.Do not change */
